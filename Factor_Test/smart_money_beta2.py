...
close_1m = pd.read_csv('/Users/caichaohong/Desktop/Zenki/price/1m/close_1m.csv', index_col='Unnamed: 0')
vol_1m = pd.read_csv('/Users/caichaohong/Desktop/Zenki/price/1m/money_1m.csv', index_col='Unnamed: 0')
...
vol_1 = vol_1m.div(vol_1m.sum(axis=1),axis=0)
vol_1 = vol_1.fillna(0)
vol_1m_res = vol_1.sub(vol_1.mean(axis=1),axis=0)

rts_res = close_open_rts.sub(close_open_rts.mean(axis=1),axis=0)

s1 = rts_res / (vol_1m_res)
