...
close_5m_rts.drop(close_5m_rts.index[47::48], inplace=True)

f1 = close_5m_rts - close_5m_rts.rolling(47).mean()
f2 = abs(f1)

tmp = f2.rolling(47).std() / f2.rolling(47).sum()
factor = tmp.iloc[46::47]
