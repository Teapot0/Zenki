...
rts_crt = 0.005
a = vol_1m[close_1m_rts > rts_crt].rolling(240, min_periods=1).std()
b = vol_1m[close_1m_rts < -rts_crt].rolling(240, min_periods=1).std()

rts_crt2 = 0.001
c = vol_1m[abs(close_1m_rts) < rts_crt2].rolling(240, min_periods=1).std()

tmp_factor = a.iloc[239::240,] / b.iloc[239::240,]
# tmp_factor = c.iloc[239::240,]
factor = tmp_factor
