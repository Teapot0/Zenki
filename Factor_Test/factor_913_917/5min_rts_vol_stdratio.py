...
close_5m = close_5m[vol_5m.columns]
...
a = vol_5m[close_5m_rts > 0].rolling(48, min_periods=1).std()
b = vol_5m[close_5m_rts < 0].rolling(48, min_periods=1).std()
factor = a.iloc[47::48,] / b.iloc[47::48]
