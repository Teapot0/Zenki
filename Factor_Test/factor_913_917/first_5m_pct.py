...
hs300_5m['rts'] = hs300_5m['close'].pct_change(1)

ex_rts = close_5m_rts.sub(hs300_5m['rts'],axis=0)


a = ex_rts.rolling(48, min_periods=1).quantile(0.5)
b = vol_5m[ex_rts< a].rolling(48, min_periods=1).std()
factor = b.iloc[47::48]
