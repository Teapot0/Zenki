...
#
a1 = pd.read_parquet('./data/vol_1m_rts_daily_q85.parquet')
a2 = pd.read_parquet('./data/vol_1m_rts_daily_q15.parquet')

c1 = close_1m[vol_1m <= a2]
v1 = vol_1m[vol_1m <= a2]
...
# f1.to_parquet('./data/vwap_big85vol.parquet')
f1.to_parquet('./data/vwap_small15vol.parquet')
