...
vol_ma5 = vol_1m.rolling(5, min_periods=1).mean()
vol_ma10 = vol_1m.rolling(10, min_periods=1).mean()
pt1 = (vol_1m / vol_ma5).rolling(237,min_periods=1).std()
pt2 = (vol_1m / vol_ma10).rolling(237,min_periods=1).mean()
