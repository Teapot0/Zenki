...
price_avg = money_5m.rolling(5).sum() / vol_5m.rolling(5).sum()
price_avg_std = price_avg.rolling(5).std()
...
#  corr
factor = (- price_avg.rolling(48).corr(price_avg_std)).rolling(240).min().iloc[47::48]
