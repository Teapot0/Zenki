...
money_daily = pd.read_csv('/Users/caichaohong/Desktop/Zenki/price/daily/money.csv',index_col='Unnamed: 0')
...
# factor = pd.read_csv('/Users/caichaohong/Desktop/Zenki/factors/191/alpha_036.csv', index_col='Unnamed: 0')
vwap = money_daily / vol_daily
factor = (vol_daily.rank(axis=1).rolling(6).corr(vwap.rank(axis=1))).rolling(2).sum().rank(axis=1)
