...
def std_rts_select_new(close, hs300, std_n1=20, std_n2=90, std1=0.2, std2=0.3,
...
daily_rts = std_rts_select_new(tmp_close, hs300=hs300, std_n1=10, std_n2=40, std1=0.2, std2=0.2,
