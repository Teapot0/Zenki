...
# close_ex_20 = close /close_ma_20 -1
#
# hs300['ex_20'] = np.nan
# for date in tqdm(hs300.index):
#     tmp_holds =eval(hs300_holds['hs300'].loc[date])
#     hs300['ex_20'].loc[date] = (close_ex_20[tmp_holds].loc[date]>0).sum()
# # hs300['ex_20'] = StandardScaler().fit_transform(hs300['ex_20'].values.reshape(1,-1))
#
# ax1 = plt.subplot()
# ax2 = ax1.twinx()
# ax1.plot(hs300['net_value'],'black')
# ax2.plot(hs300['ex_20'],'red')
...
# rs_300 = get_rsrs(high=hs300['high'], low=hs300['low'],N=120,n=20)
# hs300['rs_300'] = rs_300['signal'].loc[hs300.index]
# rs_ex_df = rs_df.sub(hs300['rs_300'],axis=0)
